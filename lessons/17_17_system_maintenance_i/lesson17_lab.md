# Lesson 17 — 17 System Maintenance I

> Build from source: configure/make/install.
...
### Build from source
```bash
echo './configure && make && sudo make install (offline outline)'
```

## Verification
- Capture outputs into `lab17_results.txt`.
