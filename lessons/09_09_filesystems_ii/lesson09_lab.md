# Lesson 09 — 09 Filesystems II

> fsck, tune2fs, xfs_repair, SMART.
...
### fsck/xfs/SMART
```bash
sudo tune2fs -l /dev/sda1 || true
sudo xfs_repair -n /dev/sda1 || true
sudo smartctl -H /dev/sda || true
```

## Verification
- Capture outputs into `lab09_results.txt`.
