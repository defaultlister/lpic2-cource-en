# Lesson 11 — 11 Storage I (RAID)

> mdadm RAID0/1/5, /proc/mdstat.
...
### mdadm RAID sim
```bash
echo 'Use loop devices: fallocate -l 500M disk1.img; losetup -fP disk1.img; mdadm --create ...'
```

## Verification
- Capture outputs into `lab11_results.txt`.
