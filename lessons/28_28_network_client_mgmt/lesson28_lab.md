# Lesson 28 — 28 Network Client Mgmt

> DHCP server/client, LDAP basics, PAM/SSSD.
...
ldapsearch -x -LLL -H ldap://localhost -b dc=example,dc=com || true
authselect current || true
```

## Verification
- Capture outputs into `lab28_results.txt`.
